...
@section('content')
    <div>
        <h4 class="title-color">Status Pengaduan</h4>
    </div>
                ...
                <div class="order-box">
                    <div class="media">
                        <a href="javascript:void(0)" class="content-box">
                            ...
                            <h2 class="font-xs content-color">Biaya : 
                                @if($data->biaya == null)
                                <strong>  Belum Dihitung
                                </strong>
                                @else
                                Rp.{{ $data->biaya }}
                                @endif
                    ...
                    <div class="bottom-content">
                        <a href="{{ route('detailhistory', $data->id_laporan) }}" class="btn btn-info">Detail Status Pengaduan</a>
                    </div>
                </div>
                <hr>
            @endforeach
