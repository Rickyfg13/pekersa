...
@section('title', 'Web Pengaduan ATIP - Edit Data Pimpinan')
@section('content')
            ...
            <div class="container-fluid">
                <div class="page-titles">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="javascript:void(0)">Edit Data Pimpinan</a></li>
                    </ol>
                </div>
    <div class="row">
    <div class="col-12 col-md-12 col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form action="{{route('updatepimpinan', $pimpinan->id_user)}}" method="POST">
                                 @csrf
                                 @method('patch')
                                 <label @error('nip')
                                            class="text-danger"
                                    ...
                                    @error('unit_kerja')
                                        ...
                                        <div class="input-group mb-3 ">
                                            ...
                                            <select name="unit_kerja" id="" class="form-control" value="{{$pimpinan->unit_kerja}}">
                                    ...
                                    @error('jabatan')
                                        ...
                                        <div class="input-group mb-3 ">
                                            ...
                                            <select name="jabatan" id="" class="form-control" value="{{$pimpinan->jabatan}}">
                                    ...
                                    @error('no_hp')
                                        ...
                                        <div class="input-group mb-3 ">
                                            ...
                                            <input type="text" class="form-control" name="no_hp" value="{{$pimpinan->no_hp}}">
                                        </div>
                                         <label @error('email')
                                            class="text-danger"
                                        @enderror>Email
                                    ...
                                    @error('password')
                                        ...
                                        <div class="input-group mb-3 ">
                                            ...
                                            <input type="text" class="form-control" name="password" value="{{$pimpinan->password_text}}">
                                        </div>
