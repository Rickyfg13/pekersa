...
@section('title', 'Web Pengaduan ATIP - Data Pelapor')
@section('content')
        ...
        <div class="container-fluid">
            <div class="page-titles">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="javascript:void(0)">Data Pelapor</a></li>
                </ol>
            </div>
            ...
            <div class="col-12 col-md-12 col-lg-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="{{ route('addpelapor') }}" class="btn btn-rounded btn-info"><span
                                class="btn-icon-left text-info"><i class="fa fa-plus color-info"></i>
                            </span>Tambah Data Pelapor</a>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered table-datatables">
                                ...
                                <tbody>
                                    @foreach ($pelapor as $no => $data)
                                        <tr>
                                            <th>{{ $pelapor->firstItem() + $no }}</th>
                                            <td>{{ $data->nip }}</td>
                                            <td>{{ $data->nama }}</td>
