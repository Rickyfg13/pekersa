                                 ...
                                 <label @error('nip')
                                    ...
                                    @error('nip')
                                        ...
                                        <div class="input-group mb-3 ">
                                            ...
                                            <input type="text" class="form-control" name="nip" value="{{$pelapor->nip}}">
                                        </div>
                                        <label @error('nama')
                                            class="text-danger"
                                        @enderror>Nama
                                    @error('nama')
                                        ...
                                        <div class="input-group mb-3 ">
                                            ...
                                            <input type="text" class="form-control" name="nama" value="{{$pelapor->nama}}">
                                        </div>
                                    ...
                                    @error('unit_kerja')
                                        ...
                                        <div class="input-group mb-3 ">
                                            ...
                                            <select name="unit_kerja" id="" class="form-control" value="{{$pelapor->unit_kerja}}">
                                    ...
                                    @error('jabatan')
                                        ...
                                        <div class="input-group mb-3 ">
                                            ...
                                            <select name="jabatan" id="" class="form-control" value="{{$pelapor->jabatan}}">
                                    ...
                                    @error('no_hp')
                                        ...
                                        <div class="input-group mb-3 ">
                                            ...
                                            <input type="text" class="form-control" name="no_hp" value="{{$pelapor->no_hp}}">
                                        </div>
                                         <label @error('email')
                                            class="text-danger"
                                        @enderror>Email
                                    @error('email')
                                        ...
                                        <div class="input-group mb-3 ">
                                            ...
                                            <input type="text" class="form-control" name="email" value="{{$pelapor->email}}">
                                        </div>
                                    ...
                                    @error('password')
                                        ...
                                        <div class="input-group mb-3 ">
                                            ...
                                            <input type="password" class="form-control" name="password" value="{{$pelapor->password_text}}">
                                        </div>
