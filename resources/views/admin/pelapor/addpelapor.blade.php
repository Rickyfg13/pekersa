...
@section('title', 'Web Pengaduan ATIP - Tambah Data Pelapor')
@section('content')
        ...
        <div class="container-fluid">
            <div class="page-titles">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="javascript:void(0)">Tambah Data Pelapor</a></li>
                </ol>
            </div>
            <div class="row">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="basic-form">
                                <form action="{{ route('tambahpelapor') }}" method="POST">
                                    @csrf
                                    <label
                                        @error('nip')
                                            class="text-danger"
